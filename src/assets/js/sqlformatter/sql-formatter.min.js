!function (e, E) {
    ...
    return function (e) {
        ...
        E.__esModule = !0;
        var r = t(18), T = n(r), R = t(19), o = n(R), N = t(20), A = n(N), I = t(21), O = n(I);
        E["default"] = {
            format: function (e, E) {
        ...
        var n = t(39), r = "object" == typeof self && self && self.Object === Object && self,
        ...
        E.__esModule = !0;
        var r = t(1), T = n(r), R = t(66), o = n(R), N = t(7), A = n(N), I = t(15), O = n(I), i = t(16), S = n(i),
            u = t(17), L = n(u), C = function () {
                function e(E, t) {
                ...
                return e.prototype.format = function (e) {
                    var E = this.tokenizer.tokenize(e), t = this.getFormattedQueryFromTokens(E);
                    return t.trim()
        ...
        E.__esModule = !0;
        var r = t(1), T = n(r), R = t(58), o = n(R), N = t(53), A = n(N), I = t(7), O = n(I), i = function () {
            function e(E) {
            ...
            return e.prototype.createLineCommentRegex = function (e) {
                ...
                return this.getTokenOnFirstMatch({input: e, type: O["default"].STRING, regex: this.STRING_REGEX})
                ...
                return this.getPlaceholderTokenWithKey({
                    ...
                    parseKey: function (e) {
                        return E.getEscapedPlaceholderKey({key: e.slice(2, -1), quoteChar: e.slice(-1)})
                    }
                })
                ...
                var E = e.input, t = e.regex, n = e.parseKey,
                    r = this.getTokenOnFirstMatch({input: E, regex: t, type: O["default"].PLACEHOLDER});
                ...
                return this.getTokenOnFirstMatch({input: e, type: O["default"].NUMBER, regex: this.NUMBER_REGEX})
            }, e.prototype.getOperatorToken = function (e) {
                return this.getTokenOnFirstMatch({input: e, type: O["default"].OPERATOR, regex: this.OPERATOR_REGEX})
                ...
                return this.getTokenOnFirstMatch({input: e, type: O["default"].WORD, regex: this.WORD_REGEX})
            }, e.prototype.getTokenOnFirstMatch = function (e) {
                var E = e.input, t = e.type, n = e.regex, r = E.match(n);
        ...
        var r = t(26), T = t(14), R = 1 / 0, o = r ? r.prototype : void 0, N = o ? o.toString : void 0;
        e.exports = n
    }, function (e, E) {
        function t(e) {
            if (null != e) {
        ...
        var r = t(6), T = "[object Function]", R = "[object GeneratorFunction]", o = Object.prototype, N = o.toString;
        e.exports = n
    }, function (e, E) {
        function t(e) {
        ...
        var r = t(13), T = "[object Symbol]", R = Object.prototype, o = R.toString;
        e.exports = n
    }, function (e, E, t) {
        "use strict";
        ...
        E.__esModule = !0;
        var r = t(1), T = n(r), R = t(61), o = n(R), N = t(60), A = n(N), I = "top-level", O = "block-level",
            i = function () {
                function e(E) {
        ...
        E.__esModule = !0;
        var r = t(1), T = n(r), R = t(7), o = n(R), N = 50, A = function () {
            function e() {
            ...
            return e.prototype.beginIfPossible = function (e, E) {
                ...
                for (var t = 0, n = 0, r = E; e.length > r; r++) {
                    ...
                    if (T.type === o["default"].OPEN_PAREN) n++; else if (T.type === o["default"].CLOSE_PAREN && (n--, 0 === n)) return !0;
                    if (this.isForbiddenToken(T)) return !1
                }
                return !1
            }, e.prototype.isForbiddenToken = function (e) {
                var E = e.type, t = e.value;
        ...
        E.__esModule = !0;
        var r = t(1), T = n(r), R = t(4), o = n(R), N = t(5), A = n(N),
        ...
        var n = t(3), r = t(2), T = n(r, "DataView");
        e.exports = T
    }, function (e, E, t) {
        var n = t(3), r = t(2), T = n(r, "Map");
        e.exports = T
    }, function (e, E, t) {
        var n = t(3), r = t(2), T = n(r, "Promise");
        e.exports = T
    }, function (e, E, t) {
        var n = t(3), r = t(2), T = n(r, "Set");
        e.exports = T
    }, function (e, E, t) {
        var n = t(2), r = n.Symbol;
        e.exports = r
    }, function (e, E, t) {
        var n = t(3), r = t(2), T = n(r, "WeakMap");
        e.exports = T
    }, function (e, E) {
        function t(e) {
            return e.split("")
        ...
        function t(e, E, t, n) {
            for (var r = e.length, T = t + (n ? 1 : -1); n ? T-- : ++T < r;) if (E(e[T], T, e)) return T;
            return -1
        }
        ...
        var r = t(12), T = t(45), R = t(6), o = t(11), N = /[\\^$.*+?()[\]{}|]/g, A = /^\[object .+?Constructor\]$/,
            I = Function.prototype, O = Object.prototype, i = I.toString, S = O.hasOwnProperty,
        ...
        var n = t(2), r = n["__core-js_shared__"];
        e.exports = r
    }, function (e, E) {
        (function (E) {
        ...
        var n = t(22), r = t(23), T = t(24), R = t(25), o = t(27), N = t(30), A = t(11), I = "[object Map]",
            O = "[object Object]", i = "[object Promise]", S = "[object Set]", u = "[object WeakMap]",
            L = "[object DataView]", C = Object.prototype, s = C.toString, a = A(n), f = A(r), c = A(T), p = A(R),
            l = A(o), D = N;
        (n && D(new n(new ArrayBuffer(1))) != L || r && D(new r) != I || T && D(T.resolve()) != i || R && D(new R) != S || o && D(new o) != u) && (D = function (e) {
            var E = s.call(e), t = E == O ? e.constructor : void 0, n = t ? A(t) : void 0;
            if (n) switch (n) {
                case a:
                    return L;
                case f:
        ...
        var n = "\\ud800-\\udfff", r = "\\u0300-\\u036f\\ufe20-\\ufe23", T = "\\u20d0-\\u20f0", R = "\\ufe0e\\ufe0f",
            o = "\\u200d", N = RegExp("[" + o + n + r + T + R + "]");
        e.exports = t
    }, function (e, E) {
        function t(e, E) {
        ...
        function t(e) {
            var E = e && e.constructor, t = "function" == typeof E && E.prototype || n;
            return e === t
        }
        ...
        var n = t(48), r = n(Object.keys, Object);
        e.exports = r
    }, function (e, E) {
        function t(e, E) {
            return function (t) {
        ...
        function t(e, E, t) {
            for (var n = t - 1, r = e.length; ++n < r;) if (e[n] === E) return n;
            return -1
        }
        ...
        var n = "\\ud800-\\udfff", r = "\\u0300-\\u036f\\ufe20-\\ufe23", T = "\\u20d0-\\u20f0", R = "\\ufe0e\\ufe0f",
            ...
            O = "[^" + n + "]", i = "(?:\\ud83c[\\udde6-\\uddff]){2}", S = "[\\ud800-\\udbff][\\udc00-\\udfff]",
            u = "\\u200d", L = I + "?", C = "[" + R + "]?",
            s = "(?:" + u + "(?:" + [O, i, S].join("|") + ")" + C + L + ")*", a = C + L + s,
            f = "(?:" + [O + N + "?", N, i, S, o].join("|") + ")", c = RegExp(A + "(?=" + A + ")|" + f + a, "g");
        e.exports = t
    }, function (e, E) {
        function t(e, E) {
            return e === E || e !== e && E !== E
        ...
        var r = t(9), T = /[\\^$.*+?()[\]{}|]/g, R = RegExp(T.source);
        e.exports = n
    }, function (e, E, t) {
        function n(e) {
        ...
        var r = t(56), T = "[object Arguments]", R = Object.prototype, o = R.hasOwnProperty, N = R.toString,
        ...
        (function (e) {
            var n = t(2), r = t(62), T = "object" == typeof E && E && !E.nodeType && E,
                R = T && "object" == typeof e && e && !e.nodeType && e, o = R && R.exports === T,
                N = o ? n.Buffer : void 0, A = N ? N.isBuffer : void 0, I = A || r;
            e.exports = I
        }).call(E, t(67)(e))
    }, function (e, E, t) {
        function n(e) {
        ...
        var r = t(40), T = t(54), R = t(55), o = t(8), N = t(57), A = t(46), I = t(47), O = "[object Map]",
            i = "[object Set]", S = Object.prototype, u = S.hasOwnProperty;
        e.exports = n
    }, function (e, E) {
        function t(e) {
        ...
        var r = t(34), T = t(44), R = t(64), o = t(9);
        e.exports = n
    }, function (e, E) {
        function t() {
            return !1
        ...
        var r = t(65), T = 1 / 0, R = 1.7976931348623157e308;
        e.exports = n
    }, function (e, E, t) {
        function n(e) {
            var E = r(e), t = E % 1;
        ...
        var r = t(6), T = t(14), R = NaN, o = /^\s+|\s+$/g, N = /^[-+]0x[0-9a-f]+$/i, A = /^0b[01]+$/i,
            I = /^0o[0-7]+$/i, O = parseInt;
        e.exports = n
    }, function (e, E, t) {
        function n(e, E, t) {
            if (e = N(e), e && (t || void 0 === E)) return e.replace(A, "");
            if (!e || !(E = r(E))) return e;
            var n = o(e), I = R(n, o(E)) + 1;
            return T(n, 0, I).join("")
        }

        var r = t(10), T = t(36), R = t(37), o = t(50), N = t(9), A = /\s+$/;
        e.exports = n
    }, function (e, E) {
