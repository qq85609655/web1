...
export class ConvertRuleStringreplace extends ConvertRule {
  ...
  public valid = {
    ...
    "dataList.$":{
      ...
      _fields:['sourceField','targetField','findValue', 'replaceValue'],
      sourceField:{
        status: false,
        msg: '',
        valids: [
